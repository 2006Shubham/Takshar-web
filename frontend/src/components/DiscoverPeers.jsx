                ...
                <div key={peer._id} className="flex flex-col rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                    ...
                    <div className="mt-6 flex flex-col justify-end">
                        <button
                            ...
                            className={`w-full rounded-xl px-3 py-2 text-sm font-semibold shadow-sm transition-all ${peer.localPending ? 'bg-orange-50 text-orange-700 cursor-not-allowed' : 'font-semibold text-gray-700 ring-1 ring-inset ring-gray-300 hover:bg-gray-100'
                                }`}
                        >
